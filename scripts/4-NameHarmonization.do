...
duplicates tag Name, gen(nametag) 
tab nametag 
browse if nametag > 0 //82 duplicates
...
duplicates tag Name, gen(nametag) 
tab nametag 
browse if nametag > 0 //84 single name duplicates, 3 double name duplicates
...
duplicates tag Name, gen(nametag) 
tab nametag 
browse if nametag > 0 //94 single name duplicates, 6 double name duplicates 
...
duplicates tag Name, gen(nametag) 
tab nametag 
browse if nametag > 0 //98 single name duplicates up to this point, 6 double name duplicates
...
duplicates tag Name, gen(nametag) 
tab nametag 
browse if nametag > 0 //100 single name duplicates, 9 double name duplicates
